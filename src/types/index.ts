...
export type GISLayerId =
  ...
  | "satellite"
  | "terrain"
  // Live open-source & Indian Government data feeds, shown only on the GIS
  // Intelligence page's map (NCS/USGS seismic, Open-Meteo/IMD soil moisture,
  // GSI Bhukosh susceptibility, OSM infrastructure).
  | "seismic"
  | "soil_moisture"
  | "gsi_susceptibility"
  | "osm_infrastructure";
