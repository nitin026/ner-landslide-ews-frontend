...
import { del, get, patch, post, qs, type ScopeFilter } from "./api";
 ...
 *
 * The artefact that matters after an event, when the question stops being "did the
 * model work" and becomes "was the warning issued, and did it arrive".
 */
...
export const acknowledgeAlert = (id: string, actor = "Duty officer") =>
  transition(id, "acknowledge", { actor });
